...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
        ...
        * |---------+-------+------+------+------+------+------+------+------+------+------+------+-------+--------+----------|
        * |             | Left  |Down| Right | Pgdn|          |          |         |         |         |  rgb  |          |          | EEP_RST |       |
        * |---------+-------+------+-------+------+------+------+------+------+------+------+------+----------------+---------|
        * |             |          |          |          |          |         |          |         |         |          |         |          |         |  Vol+   |  Mute   |
        * |---------+------+------+------+------+------+------+------+------+------+------+------+------+---------+----------|
        * |            | --------------------------------------------------------------------------------------------------------------.
         */
			...
			_______,      _______,  KC_LEFT,  KC_DOWN, KC_RIGHT,KC_PGDN, _______, _______, _______, RGB_TOG, _______,  _______,          EEP_RST, _______,\
        ...
        */
		    ...
		    _______,       _______,  RGB_MOD, RGB_HUI,RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, _______, _______, _______,  _______, _______,    _______,\
