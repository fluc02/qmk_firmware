...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
        ...
        * |---------+-------+------+------+------+------+------+------+------+------+------+------+-------+--------+----------|
        * |             |       | Home|  Up  |  End | Pgup |         |         |  Ins   |         |  PScr |Slock| Pause| DFU  |               |
        * |---------+-------+------+------+------+------+------+------+------+------+------+------+-------+--------+----------|
        * |             |       |Left  |Down| Right | Pgdn|         |         |         |         |      |          |          | EEP_RST |       |
        * |---------+-------+------+-------+------+------+------+------+------+------+------+------+----------------+---------|
        * |             |          |          |          |          |         |          |         |         |          |         |          |         |  Vol+   |  Mute   |
        * |---------+------+------+------+------+------+------+------+------+------+------+------+------+---------+----------|
        * |            |          |           |                                                  |            |            |           |  Prev   |  Vol-    |    Next   |
        * ,----------------------------------------------------------------------------------------------------------------------------.
         */
		    ...
		    _______,    _______, KC_HOME, KC_UP, KC_END,KC_PGUP,  _______, _______, KC_INS, _______, KC_PSCR, KC_SLCK,  KC_PAUS, RESET,    _______,\
			_______,    _______,  KC_LEFT,  KC_DOWN, KC_RIGHT,KC_PGDN,  _______, _______, _______, _______, _______,  _______,          EEP_RST,  _______,\
        ...
        * |             |           |         |         |         |          |          |          |          |         |         |          |           |            |               |
        * |---------+-------+------+------+------+------+------+------+------+------+------+------+-------+--------+----------|
        * |             |          |  Color1 Sat- | Color1 Sat+ | Color2 Sat- | Color2 Sat+         |          |         |         |          |         |          |          |            |              |
        * |---------+-------+------+------+------+------+------+------+------+------+------+------+-------+--------+----------|
        * |             | Prev. Effect | Next Effect | Color1 Hue- | Color1 Hue+ | Color2 Hue- | Color2 Hue+ | Backlight- | Backlight+ | Spd- | Spd+        |          |          |             |               |
        * |---------+------+------+------+------+------+------+------+------+------+------+------+------+---------+----------|
        * |            |          |           |                                                  |            |            |           |            |             |               |
        * ,----------------------------------------------------------------------------------------------------------------------------.
        */
		    ...
		    _______,       _______,  _______, _______,  _______, _______, _______,_______, _______, _______, _______, _______,  _______, _______,    _______,\
			_______,     _______,  S1_DEC, S1_INC,  S2_DEC, S2_INC, _______, _______, _______, _______, _______,  _______,          _______,  _______,\
